    ...
    return (
        <section className="about-wrapper">
            <div className="about-image-container first" >
                <img className="image-about dark" src="./assets/images/image-about-dark.jpg" alt="image of a dark chair" />
            </div>
            ...
            <div className="about-image-container second">
                <img className="image-about light" src="./assets/images/image-about-light.jpg" alt="image of a piece of furniture in a light theme" />
            </div>
        </section>
    )
}
