    ...
    return (
        <section className="about-wrapper">
            <div className="about-image-container first" >
                <img className="image-about dark" src="./src/assets/images/image-about-dark.jpg" alt="" />
            </div>
            ...
            <div className="about-image-container second">
                <img className="image-about light" src="./src/assets/images/image-about-light.jpg" alt="" />
            </div>
        </section>
    )
}
